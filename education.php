...
<html lang="en" dir="ltr">
  ...
  <h1 style="margin-top:50px;font-family:'Bungee', cursive; font-size:50px;">education</h1>

  <div class="row" style="margin-top:20px;">
    <div class="col-lg-6 col-sm-6">
      <div class="school">
        <img src="images/sacred_heart.jpeg" alt="">
        <h3>SACRED HEART HIGHSCHOOL, RATNAGIRI</h3>
    ...
    <div class="col-lg-6 col-sm-6">
      <div class="school">
        ...
        <h3>ST XAVIER'S HIGHSCHOOL, KOLHAPUR</h3>
        <h5>SSC (89.60%) 2015</h5>
      </div>
    </div>
    <div class="col-lg-6 col-sm-6">
      <div class="school">
        ...
        <h5>SCIENCE, HSC (74.31%) 2017</h5>
      </div>
    </div>
    <div class="col-lg-6 col-sm-6">
      <div class="school">
        <img src="images/sinhgad.jpg" alt="">
        <h3>SINHGAD'S SMT KASHIBAI NAVALE COLLEGE OF ENGINEERING, PUNE</h3>
        <h5>BE ELECTRONICS & TELECOMMUNICATION (AGGR CGPA: 8.54) 2021</h5>
      </div>
    </div>
  </div>
</section>
